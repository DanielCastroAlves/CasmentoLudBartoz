...
const QeA = () => {
  const data = [
    ...
    },
    {
      ...
      A: [
        "Muitos convidados vão preferir sair de Belo Horizonte de carro e poderia dar carona dividindo custos. Fique atento ao seu e-mail e posteriormente será liberado um Grupo no WhatsApp específico para discutir essas logística.",
      ],
    ...
    },
    {
      ...
      A:
       ["Em média, um vôo de Lisboa para o Rio de Janeiro é de 11 horas."],
    },
    {
    ...
    },
    {
      ...
      A: [
        "Existem dois roteiros que podem ser a melhor opção e a escolha do noivo para ir ao Brasil.",
        ["KLM:", "Cracóvia – Rio de Janeiro 09.05.2024"],
        [
