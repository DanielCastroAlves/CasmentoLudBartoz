...
export const PreWedding = () => {
  ...
  return (
    <Stack width="100%" height="100%" mb={!isMobile && 10}>
      ...
      <FirstSection
        title={text.preWedding.title[language]}
        subtitle={text.preWedding.subtitle[language]}
        paragraph1={text.preWedding.introP1[language]}
        paragraph2={text.preWedding.introP2[language]}
      />
      <LocationAndWeather
