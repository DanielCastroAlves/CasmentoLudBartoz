...
export const Header = () => {
  ...
  return (
    <Box
      width="100%"
      height={isMobile ? theme.spacing(20.2) : theme.spacing(21.5)}
      mb={isMobile ? theme.spacing(20.2) : theme.spacing(21.5)}
      sx={{ zIndex: "99" }}
    >
      <AppBar
        position="static"
            ...
            <Link to="/home">
              <Box sx={{ paddingLeft: !isMobile && 15 }}>
                <img
                  ...
                  alt="Logo Ludmila e Bartosz"
                  onMouseEnter={() => setLogoHovered(olivaLogo)}
                  onMouseLeave={() => setLogoHovered(mobileLogo)}
                />
              </Box>
            </Link>
